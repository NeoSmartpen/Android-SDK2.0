...
// Name for the SDP record when creating server socket
    ...
    private BTOfflineAdt.ListenThread mListenThread;
    private BTOfflineAdt.ConnectThread mConnectThread;
    private BTOfflineAdt.ConnectedThread mConnectionThread;

    private BTOfflineAdt.OfflineConnectedThread mOfflineConnectionThread;       //[2018.03.05] Stroke Test
    ...
    public synchronized void connect( String address, boolean isFreePass)
    {
        ...
        mConnectThread = new BTOfflineAdt.ConnectThread( device );
...
//		} );
        ...
        mConnectionThread = new BTOfflineAdt.ConnectedThread(mProtocolVer);
        mOfflineConnectionThread = new BTOfflineAdt.OfflineConnectedThread();   //[2018.03.05] Stroke Test
